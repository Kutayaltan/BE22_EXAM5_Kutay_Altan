...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 04. Aug 2024 um 17:39
...
CREATE TABLE `animals` (
  ...
  `fk_adoption_id` int(11) DEFAULT NULL
...
INSERT INTO `animals` (`id`, `fname`, `picture`, `breed`, `size`, `age`, `vaccine`, `fk_adoption_id`) VALUES
(1, 'Whiskers', 'siamese.jpg', 'Siamese', 'Medium', 2, 'Yes', NULL),
(2, 'Shadow', 'persian.jpg', 'Persian', 'Medium', 4, 'No', NULL),
(3, 'Mittens', 'maine.jpg', 'Maine Coon', 'Large', 3, 'No', NULL),
(4, 'Luna', 'british.jpeg', 'British Shorthair', 'Medium', 1, 'Yes', NULL),
(5, 'Cloud', 'van.jpg', 'Van', 'Large', 5, 'Yes', NULL);
...
INSERT INTO `pet_adoption` (`id`, `user`, `animal`, `pick_up`) VALUES
(11, 6, 2, '2024-08-09');
