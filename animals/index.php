<?php
    ...
    $sql = "SELECT * FROM `animals`";    //  LEFT JOIN suppliers ON animals.fk_supplier_id = suppliers.supplierId";
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="http://localhost:3000/animals/index.php">Animal shelter</a>
    ...
    <a href="create.php" class="btn btn-primary">Update Pet List</a>
